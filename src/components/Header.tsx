  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 px-4 md:px-8 flex items-center justify-between fixed top-0 right-0 left-0 lg:left-64 z-10 transition-all duration-300">
      ...
      <div ref={searchRef} className="flex items-center w-full max-w-[140px] sm:max-w-xs md:w-96 relative">
        ...
        {open && (
          <div className="absolute top-12 left-0 w-full bg-white border border-slate-200 rounded-2xl shadow-2xl py-3 z-50 max-h-96 overflow-y-auto animate-in fade-in slide-in-from-top-1.5 duration-200">
            {error && (
